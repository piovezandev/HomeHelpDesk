      ...
      <li><a>Bem Vindo,${login.getNome()} &nbsp;&nbsp;</a></li>
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="#listar">Tickets&nbsp;&nbsp;<span class="badge">3</span><span class="glyphicon glyphicon-list-alt pull-right"></span></a></li>
...
<ul class="nav nav-pills nav-stacked">
   ...
   <li > <a data-toggle="collapse"  href="#link2"><h5>Solicitações<span class="glyphicon glyphicon-briefcase pull-right"></span></h5></a>
       ...
       <ul class="nav nav-list">
          <li><a data-toggle="modal" href="#myModal"> Abrir</a></li>
          <li><a href="listaTickets">Listar</a></li>
       </ul>
        </div>
   </li>
   ...
   <li > <a data-toggle="collapse"  href="#link3"><h5>Graficos<span class="glyphicon glyphicon glyphicon-dashboard pull-right"></span></h5></a>
       ...
       <ul class="nav nav-list">
          <li><a href="home">Status das Solicitações</a></li>
       </ul>
        </div>
   </li>

   <li > <a data-toggle="collapse"  href="#link4"><h5>Info Conta<span class="glyphicon glyphicon-piggy-bank pull-right ">
   </span></h5></a>
        <div id="link4" class="collapse">
       <ul class="nav nav-list">
          <li><a href="menu">Detalhar</a></li>
       </ul>
        </div>
   </li>
...
<br><input type="button" class="btn btn-sm btn-success pull-right" value="enviar" onclick="sendMessage();">
 <br><br>
          </div>
         </div>
         </div>
